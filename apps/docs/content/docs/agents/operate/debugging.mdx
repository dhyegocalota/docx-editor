...
| ------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| `INVALID_ARGUMENT`        | Thrown  | Missing, unknown, or malformed argument. `details.excluded: true` means a narrowed surface refused it, and `details.reason` says which rule: `excluded`, `direct-only`, or `enforce-change-mode` | Return it to the model as a tool result. It can correct the call |
